# CafeHTML Legacy Architecture and Decisions

> Archived on 2026-08-23. This file preserves the former mixed current/legacy
> reference and its historical decisions. It is not the source of truth for the
> current Next.js product. See `docs/CafeHTML.md` for current architecture,
> `docs/ROADMAP.md` for planned work, and `docs/log.md` for session history.
